...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <p class="card-title">White Tag Functional</p>
                <div class="row">
                    <div class="col-12">
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
          <div class="modal-header p-3">
              <h5 class="modal-title" id="modal-tambahLabel">Edit Data White Tag Functional </h5>
...
<div class="modal fade" id="modal-detail" tabindex="-1" role="dialog" aria-labelledby="modal-detailLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header p-3">
                <h5 class="modal-title" id="modal-detailLabel">Detail White Tag Functional</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    function getMapComp(id) {
        const url = "{!! route('formWhiteTag') !!}?id="+id+"&type=functional";
        $.ajax({
            url:url,
            cache:false,
    ...
    function detailWhiteTag(id) {
        const url = "{{ route('detailWhiteTag') }}?id="+id+"&type=functional";
